 ...
 * 
 * WinUtils.java at 2015-2-1 20:25:37, original version by lornwolf.
...
public class WinUtils
{
    ...
    //* copy from WindowsGraphicsUtils START (modified by lornwolf)
    /**
    ...
    static void paintClassicText(AbstractButton b, Graphics g, int x, int y,
        ...
        if(model.isEnabled()) {
            ...
            MySwingUtilities2.drawStringUnderlineCharAt(b
                    , g,text, mnemIndex, x, y); // 为了非公开api的兼容性
            ...
            if(model.isArmed()) {
                ...
                MySwingUtilities2.drawStringUnderlineCharAt(b, g, text, mnemIndex,
                        x + 1, y + 1);//* modified by lornwolf 为了非公开api的兼容性
            }
            if (color == null) {
            ...
            MySwingUtilities2.drawStringUnderlineCharAt(
                    b, g, text, mnemIndex, x, y);//* modified by lornwolf 为了非公开api的兼容性
            
        }
    }
    //* copy from WindowsGraphicsUtils END (modified by lornwolf)
