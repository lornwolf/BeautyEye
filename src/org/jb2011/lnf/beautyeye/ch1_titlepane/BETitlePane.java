 ...
 * 
 * BETitlePane.java at 2015-2-1 20:25:36, original version by lornwolf.
                    ...
                    UIManager.getString("BETitlePane.setupButtonText",getLocale()))
            {
                public void actionPerformed(ActionEvent e)
                {
                    JOptionPane.showMessageDialog(rootPane, "This button just used for demo." +
                            ...
                            "BeautyEye L&F developed by lornwolf, you can mail with jb2011@163.com.");
                }
            };
        }
    }
...
//        setupButton.setToolTipText("设置");
        ...
        closeButton.setToolTipText(UIManager.getString("BETitlePane.closeButtonToolTipext",getLocale()));
        ...
        if (getWindowDecorationStyle() == JRootPane.FRAME)
        {
            ...
            iconifyButton.setToolTipText(UIManager.getString("BETitlePane.iconifyButtonToolTipText",getLocale()));
            ...
            toggleButton.setToolTipText(UIManager.getString("BETitlePane.toggleButtonToolTipText",getLocale()));
        }
    }
    /**
