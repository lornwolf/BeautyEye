...
public class __UI__ {
    ...
    public static void uiImpl() {
        ...
        UIManager.put("List.focusCellHighlightBorder",new BorderUIResource(BorderFactory.createEmptyBorder(1, 8, 5, 3)));
        /* ~~注：这个属性是jb2011为了更好的ui效果自已加的属性 */
        UIManager.put("List.focusSelectedCellHighlightBorderColor", new ColorUIResource(new Color(252,87,84)));
    ...
    //本border由lornwolf实现，它是列表单元获得焦点时的边框（windows外观
