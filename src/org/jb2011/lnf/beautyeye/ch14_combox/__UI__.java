 ...
 * 
 * __UI__.java at 2015-2-1 20:25:37, original version by lornwolf.
...
public class __UI__
{
    ...
    {
        /* ~~注：这个属性是lornwolf仿照JTabel里的实现自已加的属性，目的是控制选择框的弹出列表的边框空白 */
...
//        UIManager.put("ComboBox.buttonBackground",new ColorUIResource(BeautyEyeLNFHelper.commonBackgroundColor));
        ...
        /* ~~注：这个属性是lornwolf为了更好的ui效果和方便未来的设定自已加的属性 */
        //用于修正下拉框的弹出窗的X坐标
