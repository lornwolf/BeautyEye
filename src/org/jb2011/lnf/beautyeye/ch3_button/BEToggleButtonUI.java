 ...
 * 
 * BEToggleButtonUI.java at 2015-2-1 20:25:40, original version by lornwolf.
...
public class BEToggleButtonUI extends BasicToggleButtonUI//WindowsToggleButtonUI//
{
    ...
    //* 由lornwolf于2012-10-12日加入：重写本方法的目的是使得JToggleButton不填充
...
//            SwingUtilities2 *不要直接调用该类（因为它是sun未公开api，1.5里与1.6及以后版它放在不同的包里，某天它会消失也说不好）
            ...
            Rectangle viewRect, Rectangle textRect, Rectangle iconRect)
    {
        ...
        //绘制焦点虚线框
        g.setColor(UIManager.getColor("ToggleButton.focusLine"));//*~ 这是lornwolf自定义的属性哦
        BEUtils.drawDashedRect(g, x, y, w, h, 17, 17, 2, 2);
        //再绘制焦点虚线框的立体高亮阴影，以便形成立体感
        g.setColor(UIManager.getColor("ToggleButton.focusLineHilight"));//*~ 这是lornwolf自定义的属性哦
